...
variable "azure_signalr_connection_string" {
  description = "Azure SignalR Service connection string for production SignalR traffic"
  type        = string
  sensitive   = true
}
...
variable "help_firebase_site" {
  description = "Optional Firebase Hosting site id for the help center; defaults to <project_id>-help when empty"
  type        = string
  default     = ""
}
