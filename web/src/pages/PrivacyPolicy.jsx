  ...
  return (
    <PublicLayout>
      <div className="max-w-4xl mx-auto px-4 py-8 bg-white shadow-md rounded-lg">
        ...
        <p className="mb-4"><strong>Team Chords</strong> ("us", "we", or "our") operates <strong>{window.location.origin}</strong> (hereinafter referred to as <strong>"Service"</strong>).</p>
        <p className="mb-4">Our Privacy Policy governs your visit to <strong>{window.location.origin}</strong>, and explains how we collect, safeguard and disclose information that results from your use of our Service.</p>
        ...
        <p className="mb-4"><strong>SERVICE</strong> means the {window.location.origin} website operated by Team Chords.</p>
